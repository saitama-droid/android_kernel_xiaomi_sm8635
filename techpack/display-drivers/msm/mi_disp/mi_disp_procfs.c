...
static int mi_disp_procfs_dsi_phy_rw_init(void *d_display, int disp_id) {
  ...
  if (is_support_disp_id(disp_id)) {
    disp_procfs.dsi_phy_rw_proc[disp_id] = proc_create_data(
        dsi_phy_rw_str[disp_id], S_IRUGO | S_IWUSR, disp_core->procfs_dir,
...
static int mi_disp_procfs_dsi_porch_rw_init(void *d_display, int disp_id) {
  ...
  if (is_support_disp_id(disp_id)) {
    disp_procfs.dsi_porch_rw_proc[disp_id] = proc_create_data(
        dsi_porch_rw_str[disp_id], S_IRUGO | S_IWUSR, disp_core->procfs_dir,
...
static int mi_disp_procfs_pps_rw_init(void *d_display, int disp_id) {
  ...
  if (is_support_disp_id(disp_id)) {
    disp_procfs.pps_rw_proc[disp_id] =
        proc_create_data(pps_rw_str[disp_id], S_IRUGO | S_IWUSR,
