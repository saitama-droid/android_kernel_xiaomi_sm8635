...
int fsm_regmap_bulkwrite(fsm_dev_t *fsm_dev, uint8_t reg, uint8_t *pval,
                         uint32_t len);
int fsm_regmap_read(fsm_dev_t *fsm_dev, uint8_t reg, uint16_t *pval);
int fsm_regmap_bulkread(fsm_dev_t *fsm_dev, uint8_t reg, uint8_t *pval,
                        uint32_t len);
int fsm_regmap_update_bits(fsm_dev_t *fsm_dev, uint8_t reg, uint8_t mask,
                           uint8_t val);
...
uint16_t fsm_cal_threshold(fsm_dev_t *fsm_dev, int mt_type, uint16_t zmdata);
...
int fsm_hal_bulkwrite(fsm_dev_t *fsm_dev, uint8_t reg, uint8_t *val,
                      uint32_t len);
int fsm_hal_bulkread(fsm_dev_t *fsm_dev, uint8_t reg, uint32_t len,
                     uint8_t *val);
...
int fstool_bulkwrite(uint8_t addr, uint8_t reg, uint32_t len, uint8_t *val);
int fstool_bulkread(uint8_t addr, uint8_t reg, uint32_t len, uint8_t *val);
